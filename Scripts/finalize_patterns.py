...
def runMain(dir_name, ratio=0.8247):
    ...
    for name in file_name_list:
        ...
        w.write("{0},{1}\n".format(file_base_probs[0], "malicious" if float(file_base_probs[2])/file_base_probs[1]>=ratio else "benign"))
        ...
        for line in r:
            ...
            yes_val = True if float(line[2])/line[1] >= ratio else False
